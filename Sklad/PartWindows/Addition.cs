...
namespace Sklad.PartWindows
{
    public partial class Addition : Form
    {
        ...
        private void Addition_Resize(object sender, EventArgs e)
        {
            AdjustForm();
        }

        private void BackButtonAdding_Click(object sender, EventArgs e)
        {
            main.Top = this.Top;
            main.Left = this.Left;
            main.Size = this.Size;
        ...
        private void Addition_Load(object sender, EventArgs e)
        {
            ...
            {
                var sheets = db.Sheets.Where(e => e.ActionType == Models.Action.Addition).ToList();
                AdditionDataGrid.DataSource = sheets;
            }
        }
    }
}
