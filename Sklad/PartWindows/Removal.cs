...
namespace Sklad.PartWindows
{
    public partial class Removal : Form
    {
        ...
        private void Removal_Resize(object sender, EventArgs e)
        {
            AdjustForm();
        }

        private void BakButtonRemoval_Click(object sender, EventArgs e)
        {
            main.Top = this.Top;
            main.Left = this.Left;
            main.Size = this.Size;
        ...
        private void Removal_Load(object sender, EventArgs e)
        {
            ...
            {
                var sheets = db.Sheets.Where(e => e.ActionType == Models.Action.Removal).ToList();
                RemovalDataGrid.DataSource = sheets;
            }
        }
    }
}
