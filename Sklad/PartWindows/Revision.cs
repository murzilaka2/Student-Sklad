...
namespace Sklad.PartWindows
{
    public partial class Revision : Form
    {
        ...
        private void Revision_Resize(object sender, EventArgs e)
        {
            AdjustForm();
        }

        private void BaskButtonRevision_Click(object sender, EventArgs e)
        {
            main.Top = this.Top;
            main.Left = this.Left;
            main.Size = this.Size;
        ...
        private void Revision_Load(object sender, EventArgs e)
        {
            ...
            {
                var sheets = db.Sheets.Where(e => e.ActionType == Models.Action.Editing).ToList();
                RevisionDataGrid.DataSource = sheets;
            }
        }
    }
}
