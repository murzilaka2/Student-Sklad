...
namespace Sklad.Windows
{
    public partial class AddStorage : Form
    {
        ...
        private void CloseStorageButton_Click(object sender, EventArgs e)
        {
            Application.Exit();
        }
        private void MinimizeStorageButton_Click(object sender, EventArgs e)
        {
        ...
        private void HideStorageButton_Click(object sender, EventArgs e)
        {
        ...
        private void AddStorage_Resize(object sender, EventArgs e)
        {
            AdjustForm();
        }
